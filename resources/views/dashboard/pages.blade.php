...
<div class="container-fluid">
        ...
        <div class="main-view" style="width:80%; margin:0 auto;">
          ...
          <div class="row placeholders chart-highlights" style="text-align=Center;">
            <div class="col-xs-6 col-sm-3 placeholder text-center" style="border-radius:100%; background-color:#000; color:#FFF; width:200px; height:200px; padding-top:36px; margin-left:2%; margin-right:10%;">
            <h1>#5000 </h1>
              <h4>Clicks</h4>
            </div>
             <div class="col-xs-6 col-sm-3 placeholder text-center" style="border-radius:100%; background-color:#000; color:#FFF; width:200px; height:200px; padding-top:36px; margin-right:10%;">
            <h1>#5000 </h1>
              <h4>Impressions</h4>
            </div>
             <div class="col-xs-6 col-sm-3 placeholder text-center" style="border-radius:100%; background-color:#000; color:#FFF; width:200px; height:200px; padding-top:36px; margin-right:10%;">
