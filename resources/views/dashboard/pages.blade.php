...
<div class="container-fluid">
        ...
        <div class="main-view" style="width:80%; margin:0 auto;" ng-app="myApp" ng-controller="customersCtrl">
          ...
          <div id="summarise" class="row placeholders chart-highlights" style="text-align=Center;">
            ...
            <div class="circle-home"><span get-value="" max="upperCount">00</span><br/><span class="circle-home-score " id="counterofreviews" data-count="@{{upperCount}}"><h1><strong>@{{noReviews}}</strong></span></h1></div>
