...
return [
    ...
    'providers' => [
        'facebook' => [
            ...
            'redirect_uri' => 'http://web-1.redfusionstackwebndb.43db88ef.cont.dockerapp.io/auth/login/facebook',
            'scope' => [],
        ],
        'google' => [
            'client_id' => '12345678',
        ...
        'github' => [
            ...
            'redirect_uri' => 'http://web-1.redfusionstackwebndb.43db88ef.cont.dockerapp.io/github/login',
            'scope' => [],
        ],
        'linkedin' => [
            'client_id' => '12345678',
